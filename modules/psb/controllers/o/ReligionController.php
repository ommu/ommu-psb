...
class ReligionController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = PsbReligions::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('PsbReligions', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Psb Religions');
	...
	public function actionView($id) 
	{
		...
		$this->pageTitle = Yii::t('phrase', 'View Psb Religions');
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['PsbReligions'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'PsbReligions success created.'));
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['PsbReligions'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'PsbReligions success updated.'));
					//$this->redirect(array('view','id'=>$model->religion_id));
					$this->redirect(array('manage'));
				}
			}
